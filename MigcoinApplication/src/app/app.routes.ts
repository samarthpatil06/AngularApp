...
//     path: 'dashboard',
//     loadComponent: () =>
//       import('./MainLayout/components/dashboard/dashboard.component').then(m => m.DashboardComponent)
//   },
//   {
//     path: 'view',
//     loadComponent: () =>
//       import('./MainLayout/components/view/view.component').then(m => m.ViewComponent)
//   }
